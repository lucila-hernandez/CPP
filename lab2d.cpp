...
LAB 2D: Finishing program that shows data of peoples favorite snacks with rating. 
*/
...
int main()
{
    ...
    string favoriteSnack; // most prefered snack
    ...
    cout << "The preffered soda is " << FAVORITESODA << endl;
